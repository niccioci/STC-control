...
def questionnaire_view(request):
    ...
    {'question': '6. What would have made you trust the <strong>Assistant</strong> more?'},
    {'question': '7. Please leave your comments about your experience interacting with the <strong>Assistant</strong>.'},
